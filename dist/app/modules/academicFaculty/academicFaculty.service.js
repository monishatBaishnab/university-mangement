...
const fetchAllAcademicFacultyFromDB = () => __awaiter(void 0, void 0, void 0, function* () {
    return academicFaculty_model_1.default.find();
});
const fetchSingleAcademicFacultyFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    return academicFaculty_model_1.default.findOne({ _id: id });
});
